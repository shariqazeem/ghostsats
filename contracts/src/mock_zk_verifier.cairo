...
pub mod MockZkVerifier {
    ...
    impl MockVerifierImpl of ghost_sats::shielded_pool::IZKVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            // Mock: first 3 elements of proof are [commitment, nullifier, denomination]
            // Return them as u256 public inputs so the contract's assertions pass.
            assert(full_proof_with_hints.len() >= 3, 'Mock needs 3 felt252 values');
            ...
            Result::Ok(array![commitment, nullifier, denomination].span())
        }
    }
}
